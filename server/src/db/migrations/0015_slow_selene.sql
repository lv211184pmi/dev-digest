...
CREATE INDEX "skill_context_docs_repo_path_idx" ON "skill_context_docs" USING btree ("repo_id","path");--> statement-breakpoint
CREATE INDEX "agent_context_docs_repo_path_idx" ON "agent_context_docs" USING btree ("repo_id","path");